...
% Revised version for Argentina 1989-1995, free of environmental consideration.
...
beta 	= 0.95; 	% Discount factor firms
delta 	= 0.025;	% Depreciation rate
alpha 	= 0.15;		% Capital share
...
//	PARAM NAME,		INITVAL,	LB,		UB,		PRIOR_SHAPE,		PRIOR_P1,		PRIOR_P2
	...
	stderr eta_p,   		,			,		,		INV_GAMMA_PDF,		0.05,		2;
	rho_p,					0.7,    	,		,		beta_pdf,			0.6,		0.2;
	...
	sigmaH,					1.2,   	 	,		,		gamma_pdf,			2.5,		0.5;
	hh,						0.5,    	,		,		beta_pdf,			0.6,		0.1;
	...
	phi_dy,					0.01,    	,		,		normal_pdf,			0.08,		0.03;
...
estimation(datafile=obs_arg_1989_1995,
first_obs=1,				
...
) gy_obs gc_obs gi_obs pi_obs r_obs u_obs;
...
stoch_simul(irf=30,conditional_variance_decomposition=[1,4,10,100],order=1) gy_obs gc_obs gi_obs pi_obs r_obs u_obs ;
