...
var rr c n u w y k i lb mc pi r z x v_H v_P g gy_obs_2022 gc_obs_2022 pi_obs_2022 r_obs_2022 u_obs_2022 varrho;
...
model; 
	...
	gy_obs_2022 = log(y/y(-1));
	[name='measurement consumption']
	gc_obs_2022 = log(c/c(-1));
	[name='measurement inflation']
	pi_obs_2022 = pi - steady_state(pi);
	[name='measurement interest rate']
	r_obs_2022  = r  - steady_state(r);
	[name='measurement unemployment']
	u_obs_2022  = u  - steady_state(u);
...
steady_state_model;
	...
	e_i 	= 1;
	e_r 	= 1;
	gy_obs_2022 = 0; gc_obs_2022 = 0; pi_obs_2022 = 0; r_obs_2022 = 0; u_obs_2022 = 0; 
end;


varobs gy_obs_2022 pi_obs_2022 r_obs_2022 gc_obs_2022 u_obs_2022;
...
estimation(datafile=obs_argentina_2020_2024,
first_obs=1,				
mode_compute=6,				
...
) gy_obs_2022 pi_obs_2022 r_obs_2022 gc_obs_2022 u_obs_2022;
...
stoch_simul(irf=30,conditional_variance_decomposition=[1,4,10,100],order=1) gy_obs_2022 pi_obs_2022 r_obs_2022 gc_obs_2022 u_obs_2022;
